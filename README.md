...
1. How POST requests work. 
2. How URLs are encoded when sending strings

## Video Walkthrough 

Here's a walkthrough of implemented user stories:

<img src='https://github.com/rsandeep15/TwitterClient/blob/master/demo2.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Ran into a 403 error when sending a tweet, but then I realized you can't submit the same tweet twice. 
